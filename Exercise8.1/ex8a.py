...
#Last card delt to player #1
print("Last card in hand of player #1", player1_list[2])

#Last card delt to player #2
print("Last card in hand of player #2", player2_list[2])

# Compare the ranks of the last two cards

print()
if player1_list[2].rank() == player2_list[2].rank():
    print( "Tie:", player1_list[2], "and", player2_list[2], "of equal rank" )
elif player1_list[2].rank() > player2_list[2].rank():
    print( "Player #1 wins:", player1_list[2], "of higher rank than", player2_list[2] )
else:
    print( player2_list[2], "of higher rank than", player1_list[2] )